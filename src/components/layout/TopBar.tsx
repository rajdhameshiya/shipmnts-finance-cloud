...
export function TopBar() {
  ...
  return (
    <header className="flex h-14 items-center justify-between border-b border-borderSoft bg-white px-5">
      <div>
      ...
      <div className="flex items-center">
        <label className="hidden min-w-[320px] items-center gap-2 rounded-md border border-slate-200 bg-slate-50 px-3 py-2 text-[12px] text-slate-500 focus-within:border-orange/50 focus-within:bg-white md:flex">
